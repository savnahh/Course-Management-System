...
public class AddStudent extends JFrame implements ActionListener{
    ...
    public AddStudent() {
        ...
        lblNewLabel_1 = new JLabel("ADD STUDENT");
        ...
        btnAdd3.setBounds(182, 257, 111, 33);
        panel.add(btnAdd3);
        btnAdd3.addActionListener(this);
        btnAdd3.setBorder(new CompoundBorder(new LineBorder(new Color(128, 128, 128)), null));
        btnAdd3.setFont(new Font("Trebuchet MS", Font.BOLD, 15));
        btnAdd3.setBackground(new Color(116, 192, 68));
        btnAdd3.setForeground(new Color(45, 45, 45));
                                                
    }
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == btnAdd3){
        	addCourse();
        }
    }
