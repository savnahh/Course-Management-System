...
public class DeleteModule extends JFrame implements ActionListener{
    ...
    public DeleteModule() {
        ...
        btnDel2.setBounds(196, 247, 111, 33);
        panel.add(btnDel2);
        btnDel2.addActionListener(this);
        btnDel2.setBorder(new CompoundBorder(new LineBorder(new Color(128, 128, 128)), null));
        btnDel2.setFont(new Font("Trebuchet MS", Font.BOLD, 15));
        btnDel2.setBackground(new Color(116, 192, 68));
        btnDel2.setForeground(new Color(45, 45, 45));
        ...
        lblNewLabel_3 = new JLabel("DELETE MODULE");
        lblNewLabel_3.setForeground(new Color(255, 255, 255));
        lblNewLabel_3.setFont(new Font("Times New Roman", Font.BOLD, 26));
        lblNewLabel_3.setBounds(161, 13, 263, 30);
