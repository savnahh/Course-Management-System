...
public class EditInstructor extends JFrame implements ActionListener{
    ...
    public EditInstructor() {
        ...
        lblNewLabel_1 = new JLabel("EDIT INSTRUCTOR");
        lblNewLabel_1.setFont(new Font("Times New Roman", Font.BOLD, 26));
        lblNewLabel_1.setForeground(new Color(255, 255, 255));
        lblNewLabel_1.setBounds(141, 15, 257, 27);
        ...
        btnEdit1.setBounds(182, 257, 111, 33);
        panel.add(btnEdit1);
    ...
    public void addCourse() {
    	...
    	if (ID.isEmpty() && name.isEmpty()) {
			...
			try {
	                ...
	                String sql = "UPDATE instructor SET full_name=?, course=?, level=?, module=? WHERE instructor_id=?";
