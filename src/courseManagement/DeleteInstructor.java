...
public class DeleteInstructor extends JFrame implements ActionListener{
    ...
    public DeleteInstructor() {
        ...
        lblNewLabel_1 = new JLabel("DELETE INSTRUCTOR");
        lblNewLabel_1.setFont(new Font("Times New Roman", Font.BOLD, 26));
        lblNewLabel_1.setForeground(new Color(255, 255, 255));
        lblNewLabel_1.setBounds(121, 15, 302, 27);
        ...
        lblCourse.setBounds(89, 136, 110, 22);
        panel.add(lblCourse);
        
        comboBox = new JComboBox<String>();
        comboBox.setForeground(Color.BLACK);
        comboBox.setFont(new Font("Trebuchet MS", Font.BOLD, 14));
        comboBox.setBounds(223, 138, 198, 20);
        panel.add(comboBox);
        ...
        btnDelete.setBounds(182, 257, 111, 33);
        panel.add(btnDelete);
        btnDelete.addActionListener(this);
        btnDelete.setBorder(new CompoundBorder(new LineBorder(new Color(128, 128, 128)), null));
        btnDelete.setFont(new Font("Trebuchet MS", Font.BOLD, 15));
        btnDelete.setBackground(new Color(116, 192, 68));
